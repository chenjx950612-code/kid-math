...
story.append(callout('⚠️ 每日积分上限：每个孩子每天通过"答对 / 速度加成 / 闯关 / 订正"获得的正积分，累计最多 100 分。达到 100 分后不再增加正积分（扣分仍生效），第二天本地时间零点自动重置为 0。该上限是为了防止孩子一天刷太多积分。', bg=colors.HexColor('#fff4e6'), border=CORAL))
